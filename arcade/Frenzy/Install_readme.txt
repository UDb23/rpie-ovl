...
Default setting uses overlay without on screen instructions; if you'd like these edit romname.cfg:
-  uncomment, by removing #, the specific overlay line with "_1" and delete the other uncommented overlay0_overline line.
