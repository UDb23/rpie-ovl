# Burning Force Overlay for Retropie 4.x - Retroarch

# Lr-Mame2003 (latest version with correct aspect ratio) w 1080p Display

#

# Overlay created by UDb23 (Jan 2017)
...
Includes 2 different overlays:
- Maximum game area 
- Max Integer scale (use files in the “Option 1" folder)
...
GAME SPLASHSCREEN (runcommand)
Place the RomName-launching.png (or .jpg) image in:
RetroPie/roms/mame-libretro/images/

GAME ARTWORK
Includes romname-image for use with Emulation Station's themes (requires edit gameslist.xml or local scraping tool)
